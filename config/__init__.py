...
# 应用 ID
APP_CODE = os.getenv("BKPAAS_APP_ID", "test-paasv7")
# 应用用于调用云 API 的 Secret
SECRET_KEY = os.getenv("BKPAAS_APP_SECRET", "m3d3PuSeFZYj4GFejlvo3396wSfF3F46BBwM")

# SaaS运行版本，如非必要请勿修改
RUN_VER = "open"
# 蓝鲸SaaS平台URL，例如 http://paas.bking.com
BK_URL = "http://paas-edu.bktencent.com/"
